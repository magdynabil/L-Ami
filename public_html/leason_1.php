    ...
    <div class="breadcrumbs_container">
        <div class="container">
            ...
            elseif ($code_data['code_status']=='disable'){
                ...
                $posts=mysqli_query( $connect ,"SELECT * FROM `lesson` WHERE `level`='1'and`lesson_number`='$leson_num'");
                while ( $post=mysqli_fetch_assoc($posts)){
                    ...
                    if($update_std_leson==true){
                        $msg_l='<div class="alert alert-danger font-weight-bold" role="alert">  برجاء العلم انك قد حضرت هذا الدرس من قبل  سوف تجد قائمة الدروس التي حضرتها في الصفحة الشخصيه  </div>';
                    }
                    else{
