...
<div class="super_container">
                ...
                <div class="row">
                    <div class="col">
                        <ul class="breadcrumbs_list d-flex flex-row align-items-center justify-content-start">
                            ...
                            <li><a href="all_lesson_for_3.php">الصف الثالث  </a></li>
    ...
    <div class="language">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="language_title text-center">الصف الثالث  الثانوي </br>2020/2021</div>
                    <div class="language_title text-center"> <a href = "all_test_for_3.php" type = "button" class="btn btn-primary font-weight-bold mb-1  font-italic col-lg-3" > اختبارات الصف الثالث الثانوي </a >
                    </div>
    ...
    <div class="courses">
        <div class="container">
            <div class="row courses_row">
                <div class="col-lg-4 course_col">
                    <div class="course">
                        ...
                        <div class="course_body">
                            ...
                            <form method="get" action="free_leason_for_3.php">
                ...
                <!-- Course -->
                <?php
                $posts=mysqli_query( $connect ,"SELECT * FROM lesson WHERE `level`='3'");
                    ...
                    <div class="course">
                        ...
                        <div class="course_body">
                            ...
                            <div class="course_text">
                             ...
                             <form method="get" action="leason_3.php">
