...
<div class="super_container">
    ...
    <div class="language">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="language_title text-center">اختبارات الصف الثالث الثانوي </br>2020/2021</div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4 course_col">
                    <div class="course">
                        ...
                        <div class="course_body">
                            <div class="course_title"><a href="#">الاختبار الاول</a></div>
                            <div class="course_info">
                                <ul>
                                    <li><a href="#" class="font-weight-bold">درجات الاختبار 40 درجه </a></li>
                                </ul>
                            </div>
                            <div class="course_text">
                                <p class="font-weight-bold text-dark">الدرس الاول الوحدة الاولي  </p>
                            </div>
                            <form method="get" action="free_test_for_3.php">
                                ...
                                <button name="id" id="id" class="col-lg-5 btn btn-primary   float-right  mb-2 font-weight-bold" value="1">الدخول للاختبار </button>
                            </form>
                            <form method="get" action="view_last_answer_3.php">
                                <button name="id" id="id" class=" col-lg-6 btn btn-warning font-weight-bold text-light " value="1"> اجابتك السابقة</button>
                            </form>
                        </div>
