...
<div class="container">
    ...
    <div class="row">
        ...
        while ($code=mysqli_fetch_assoc($user_name_check)){
            echo '
        <div class="card col-lg-3   " style="">
            <div class="card-body">
                <img style="width: 100%; height:100px" src="images/aziz.png" >
                <h4 class="card-subtitle mb-2  text-center text-dark font-weight-bold p-0 mt-2 mb-2">' .$code['codee'].'</h4>
                <h6 class="card-subtitle mb-2 text-center text-danger font-weight-bold p-0 m-0 ">هذا الكود يستخدم للدخول للاختبارات </h6>
